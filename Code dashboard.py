...
def main():
    ...
    st.write('Cette application montre les prédictions faites par le modèle, permettant de donner un score à chaque client pour savoir si le crédit lui a accordé ou pas') 
